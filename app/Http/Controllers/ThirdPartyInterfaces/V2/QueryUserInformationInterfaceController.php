...
use App\Http\Requests\ThirdPartyInterfaces\V2\QueryUserInformationRequest;
...
class QueryUserInformationInterfaceController extends Controller
{
    ...
    /**
     * @api            {get} /v2/query-user-information 查询用户信息
     ...
     *     curl -X "GET" "https://med-union-user-plateform.dev/api/v2/query-user-information" \
