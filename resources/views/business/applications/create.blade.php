...
@section('content')
    <form role="form" action="{{route('applications.store')}}" method="POST" id="form-validate">
        {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <input id="name_en" name="name_en" type="text" placeholder="应用的英文名称，请保证对于已有记录是唯一的" class="form-control" required>
        </div>
        <div class="form-group">
