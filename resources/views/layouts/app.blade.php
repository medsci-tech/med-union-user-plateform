          ...
          <div class="panel-heading panel-title clearfix">
            ...
            <div class="pull-right">
              ...
              @if(isset($create_button))
                <a class="btn btn-default btn-sm" href="{{$create_button['href']}}"><span
                    class="glyphicon glyphicon-plus"></span>&nbsp;新增</a>
              @endif
              @if(isset($edit_button))
                <a class="btn btn-default btn-sm " href="{{$edit_button['href']}}"><span
              ...
              @if(isset($delete_button))
                ...
                <a data-delete="delete-form-show" class="btn btn-danger btn-sm" href="javascript:;"><span
